...
for index in dirs:
    ...
    with open(label_path, 'r') as csvfile:
        ...
        for row in spamreader:
            ...
            # save image
            heatmap.save(output_pics_path + "/" +
                         FileName.split('.')[-2] + ".png", "PNG")
